            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="/" wire:navigate>Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="javascript:void(0)">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-10">
                    <div class="shadow rounded p-5 bg-white">
                        @if(session('success'))
                            <div class="alert alert-success text-success text-center mb-4">
                                {{ session('success') }}
                            </div>
                        @endif
                        <div class="row">
                                    ...
                                    <form wire:submit.prevent="submit">
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            <label for="message" class="form-label">Write
                                                Message</label>
                                            <textarea class="form-control shadow-none" id="message" rows="3" wire:model="message"></textarea>
                                        </div>
