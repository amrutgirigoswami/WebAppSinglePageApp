            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="javascript:void(0)">About</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    @if ($page->image)
                        <img loading="lazy" decoding="async" src="{{ asset('storage/' . $page->image) }}"
                            alt="{{ $page->title }}" class="rounded w-100">
                    @else
                        <img loading="lazy" decoding="async" src="{{ asset('front/images/about/about-1.jpg') }}"
                            alt="{{ $page->title }}" class="rounded w-100">
