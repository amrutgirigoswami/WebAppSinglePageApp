            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="/service" wire:navigate>Services</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                    <div class="rounded shadow py-5 px-4">
                        <div class="icon"> <i class="fas {{ $service->icon_class }}"></i>
                        </div>
                        <h3 class="mb-3">{{ $service->name }}</h3>
                        <p class="mb-4">{{ $service->short_desc }}</p> <a class="btn btn-sm btn-outline-primary" href="{{ route('service.show', $service->id) }}" wire:navigate>View
